...
df = pd.read_csv('/workspace/Linear-Regression-Project-Tutorial/data/df_data.csv')
...
filename = '/workspace/Linear-Regression-Project-Tutorial/models/clf_linear.sav'
